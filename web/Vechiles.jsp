...
<body>
    ...
    <div class="subnav-content">
      ...
      <a href="Soldiers2.jsp">See the soldiers on the battlefield</a>
        ...
        <p> <a href="Vechiles.jsp" class="active"><b><strong>Weapons</strong></b></a></p>
...
String sql ="select * from weapons order by Code";
String sql1 = "SELECT * FROM weapons where Category!='"+Pistol+"'";
...
<td><a href="Vechile_update.jsp?idweapon=<%=resultSet.getString("idweapon")%>"><button type="button" class="button"> update quantity</button></a></td>
<!-- <td><a href="Vechile_delete.jsp?idvechile=<%=resultSet.getString("idweapon") %>"><button type="button" class="button">Delete</button></a></td>
-->
<td><button type="button" id="<%=resultSet.getString("idweapon") %>" class="delete">Delete</button></td>
</tr>
...
<br><br><br>
<p align="center"> <a href="Vechile_add.jsp"><button type="button" class="button">Add</button></a>.</p>
<%
