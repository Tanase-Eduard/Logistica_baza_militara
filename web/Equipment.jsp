...
String sql ="select * from equipment order by Code";
...
<td><a href="Equipment_update.jsp?idequipment=<%=resultSet.getString("idequipment")%>"><button type="button" class="button"> update quantity</button></a></td>
<!-- <td><a href="Equipment_delete.jsp?idequipment=<%=resultSet.getString("idequipment") %>"><button type="button" class="button">Delete</button></a></td>
-->
<td><button type="button" id="<%=resultSet.getString("idequipment") %>" class="delete">Delete</button></td>
</tr>
<%
    }
%>
...
<br><br><br>
<p align="center"> <a href="Equipment_add.jsp"><button type="button" class="button">Add</button></a>.</p>
