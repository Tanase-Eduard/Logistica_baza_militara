...
String sql ="select * from ammunition where idammunition="+idammunition;
...
<h1 align="center">Update Ammunition</h1>
<form method="post" action="Ammunition_update-process.jsp" align="center">
<input type="hidden" name="idammunition" value="<%=resultSet.getString("idammunition") %>">
<input type="hidden" name="idammunition" value="<%=resultSet.getString("idammunition") %>">
<br>
<br>
