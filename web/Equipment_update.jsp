...
String sql ="select * from equipment where idequipment="+ idequipment;
...
<h1 align="center">Update Equipment</h1>
<form method="post" action="Equipment_update-process.jsp" align="center">
<input type="hidden" name="idequipment" value="<%=resultSet.getString("idequipment") %>">
<input type="hidden" name="idequipment" value="<%=resultSet.getString("idequipment") %>">
<br>
<br>
