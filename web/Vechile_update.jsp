...
String sql ="select * from weapons where idweapon="+ idweapon;
...
<h1 align="center">Update Weapon</h1>
<form method="post" action="Vechile_update-process.jsp" align="center">
<input type="hidden" name="idweapon" value="<%=resultSet.getString("idweapon") %>">
<input type="hidden" name="idweapon" value="<%=resultSet.getString("idweapon") %>">
<br>
<br>
