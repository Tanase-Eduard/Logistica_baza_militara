...
String Available ="On the Battlefield";
...
statement=connection.createStatement();
 String sql ="select * from soldiers WHERE Status='On the Battlefield' ORDER BY Name";
...
<td><a href="Soldier_back.jsp?idsoldier=<%=resultSet.getString("idsoldier")%>"><button type="button" class="button"> Come back</button></a></td>
