    ...
    <div class="subnav-content">
      ...
      <a href="Soldiers2.jsp">See the soldiers on the battlefield</a>
        ...
        <br><br><br><br><br><br><br>
                <form action="User_add-process.jsp" method="post">
            <table align="center">
                <tr>
                ...
                <tr>
                    ...
                    <td> <input type="text" name="Born" size="40" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td align="right">Identificator:</td>
                    <td> <input type="text" name="Identificator" size="40" /></td>
                </tr>
