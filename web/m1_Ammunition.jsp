...
<html>
    ...
    <body>
        ...
        <%
            ...
            ResultSet rs = jb.intoarceLinieDupaId("ammunition", "idammunition", aux);
            rs.first();
            ...
            jb.disconnect();
        %>
        <form action="m2_Ammunition.jsp" method="post">
            <table align="center">
                <tr>
                    <td align="right">id:</td>
                    <td> <input type="text" name="idammunition" size="30" value="<%= aux%>" readonly/></td>
                </tr>
                <tr>
