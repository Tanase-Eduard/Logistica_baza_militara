...
statement=connection.createStatement();
 String sql ="select * from soldiers WHERE Status='Available' ORDER BY Name";
...
-->
 <td><a href="Soldier_eat.jsp?ServiceNumber=<%=resultSet.getString("ServiceNumber") %>"><button type="button" class="button">Send to the Battlefield</button></a></td>
</tr>
...
<!--
<p align="center" > <a href="Soldiers1.jsp"><button type="button" class="button" >See Available soldiers</button></a>.</p>
<p align="center" > <a href="Soldiers2.jsp"><button type="button" class="button" >See the soldiers on the battlefield</button></a>.</p>

-->

<% //tring name=(String)session.getAttribute("Name");
