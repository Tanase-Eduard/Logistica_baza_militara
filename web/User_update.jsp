...
<form method="post" action="User_update-process.jsp" align="center" >
<input type="hidden" name="iduser" value="<%=resultSet.getString("iduser") %>">
<input type="hidden" name="iduser" value="<%=resultSet.getString("iduser") %>">
<br>
Name:<br>
...
<br>
IN:<br>
<input type="text" name="Identificator" value="<%=resultSet.getString("Identificator") %>">
<br>
Born:<br>
