...
<body>
        ...
        <p> <a href="Ammunition.jsp" class="active"><b><strong>Ammunition</strong></b></a></p>
...
String sql ="select * from ammunition order by Code";
...
<td><a href="Ammunition_update.jsp?idammunition=<%=resultSet.getString("idammunition")%>"><button type="button" class="button"> update quantity</button></a></td>
<!--<td><a href="Ammunition_delete.jsp?idammunition=<%=resultSet.getString("idammunition") %>"><button type="button" class="button">Delete</button></a></td>
-->
<td><button type="button" id="<%=resultSet.getString("idammunition") %>" class="delete">Delete</button></td>
</tr>
<%
    i++;
}
...
<br><br><br>
<p align="center"> <a href="Ammunition_add.jsp"><button type="button" class="button">Add</button></a>.</p>
